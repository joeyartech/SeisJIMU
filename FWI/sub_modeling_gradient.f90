...
if(allocated(a_star_u%geps )) call sysio_write('geps_' //shot%sindex,a_star_u%geps ,m%n)
if(allocated(a_star_u%gmu  )) call sysio_write('gmu_'  //shot%sindex,a_star_u%gmu  ,m%n)
