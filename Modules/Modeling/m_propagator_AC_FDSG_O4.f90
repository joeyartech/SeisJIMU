...
use m_cpml
    ...
    subroutine forward(self,fld_u)
        ...
        call hud('Elapsed time to extract field         '//num2str(tt6/mpiworld%max_threads))
        call hud('Elapsed time to save boundary         '//num2str(tt7/mpiworld%max_threads))
    ...
    subroutine adjoint(self,fld_a,fld_u,a_star_u,oif_record_adjseismo)
        ...
        call hud('Elapsed time to compute Poynting vectors '//num2str(tt6/mpiworld%max_threads))
        call hud('Elapsed time to correlate                '//num2str(tt7/mpiworld%max_threads))
