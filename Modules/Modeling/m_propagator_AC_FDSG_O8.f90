...
use m_boundarystore
    ...
    subroutine print_info
        ...
        call hud('Coeff: '//num2str(coef(1))//' '//num2str(coef(2))//' '//num2str(coef(3))//' '//num2str(coef(4)))
    ...
    subroutine propagate(self)
        ...
        do it=ift,ilt
            if(mod(it,500)==0) then
                ...
                if(mpiworld%is_master) call check_field(field,'field')
            endif
        ...
        call hud('time add source velocities '//num2str(tt1/mpiworld%max_threads))
        call hud('time update velocities     '//num2str(tt2/mpiworld%max_threads))
        call hud('time add source stresses   '//num2str(tt3/mpiworld%max_threads))
        call hud('time update stresses       '//num2str(tt4/mpiworld%max_threads))
        call hud('time extract field         '//num2str(tt5/mpiworld%max_threads))
        call hud('time save boundary         '//num2str(tt6/mpiworld%max_threads))
    ...
    subroutine propagate_reverse(o_sfield,o_imag,o_grad,o_rdt,dout)
        ...
        do it=ilt,ift,time_dir
            ...
            if(mod(it,500)==0) then
                ...
                if(mpiworld%is_master) then
                    call check_field(sfield,'sfield')
                    call check_field(rfield,'rfield')
                endif
            endif
        ...
        call hud('time load boundary            '//num2str(tt1/mpiworld%max_threads))
        call hud('time update stresses          '//num2str(tt2/mpiworld%max_threads))
        call hud('time rm source stresses       '//num2str(tt3/mpiworld%max_threads))
        call hud('time update velocities        '//num2str(tt7/mpiworld%max_threads))
        call hud('time rm source velocities     '//num2str(tt8/mpiworld%max_threads))
        call hud('time -------------------------')
        call hud('time add adjsource stresses   '//num2str(tt4/mpiworld%max_threads))
        call hud('time update adj stresses      '//num2str(tt5/mpiworld%max_threads))
        call hud('time add adjsource velocities '//num2str(tt9/mpiworld%max_threads))
        call hud('time update adj velocities    '//num2str(tt10/mpiworld%max_threads))
        call hud('time extract&write fields     '//num2str(tt11/mpiworld%max_threads))
        call hud('time correlation              '//num2str((tt6+tt12)/mpiworld%max_threads))
