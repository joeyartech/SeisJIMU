...
use m_cpml
    ...
    subroutine forward(self,fld_u)
        ...
        call hud('Elapsed time to add source              '//num2str(tt1/mpiworld%max_threads))
        call hud('Elapsed time to save boundary           '//num2str(tt2/mpiworld%max_threads))
        call hud('Elapsed time to update field            '//num2str(tt4/mpiworld%max_threads))
        call hud('Elapsed time to evolve field            '//num2str(tt6/mpiworld%max_threads))
        call hud('Elapsed time to extract field           '//num2str(tt7/mpiworld%max_threads))
    ...
    subroutine adjoint_poynting(self,fld_q,fld_p, fld_v,fld_u, a_star_u)
        ...
        call hud('Elapsed time to evolve field             '//num2str(tt1/mpiworld%max_threads))
        call hud('Elapsed time to load boundary            '//num2str(tt2/mpiworld%max_threads))
        call hud('Elapsed time to update field             '//num2str(tt4/mpiworld%max_threads))
        call hud('Elapsed time to rm source                '//num2str(tt6/mpiworld%max_threads))
        call hud('Elapsed time -----------------------')
        call hud('Elapsed time to add adj & virtual src    '//num2str(tt8/mpiworld%max_threads))
        call hud('Elapsed time to update adj field         '//num2str(tt9/mpiworld%max_threads))
        call hud('Elapsed time to evolve adj field         '//num2str(tt11/mpiworld%max_threads))
        call hud('Elapsed time to extract fields           '//num2str(tt12/mpiworld%max_threads))
        call hud('Elapsed time to compute Poynting vectors '//num2str(tt3/mpiworld%max_threads))
        call hud('Elapsed time to correlate                '//num2str(tt10/mpiworld%max_threads))
