...
use m_empirical
    ...
    type,public :: t_parametrizer
        ...
        character(i_str_xxlen) :: info = &
            'Parameterization: vp-ip with pseudo_vs'
...
!     logical :: is_grho,is_gbuo,is_gkpa,is_gikpa,is_glda,is_gmu
    ...
    real,dimension(:,:,:),allocatable :: is0
...
!                 self%npars=self%npars+1
    ...
    subroutine transform(self,o_dir,o_x,o_xprior,o_g)
        ...
        real,dimension(:,:,:),allocatable :: tmp_vp, tmp_ip
        real,dimension(:,:,:),allocatable :: tmp_gvp, tmp_gip
...
!
!                 lda = rho(vp^2-2vs^2) = vp*ip - 2vs*is0 = vp*ip - 2is0^2/ip*vp
