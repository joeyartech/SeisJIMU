...
use m_Modeling
    ...
    do i=1,shls%nshots_per_processor
        ...
        call shotlog_open(shot%sindex, dir_out)
...
!     write(*,'(a)') "----------------------------"
!     write(*,'(a)') ""
!     write(*,'(a)') "FILE_MODEL              'model'            #Prefix of input model name"
!     write(*,'(a)') "MODEL_SIZE              '201  201  201'    #nz nx ny"
...
!     write(*,'(a)') ""
!     write(*,'(a)') "ACQUI_GEOMETRY          'spread'           #Type of acquisition geometry"
!     write(*,'(a)') "                                           #2D:"
